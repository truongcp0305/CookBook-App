...
class OnList extends StatelessWidget {
  ...
  const OnList({required this.title,required this.queryKey,Key? key}) : super(key: key);

  OnList createState() => OnList(title: title, queryKey: queryKey,);
      ...
      body: Column(
        children: [
         Padding(
          ...
          Expanded(
            child: FutureBuilder(
              future: db.getCategory(queryKey),
              initialData: const [],
